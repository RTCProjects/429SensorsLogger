...
/*----------------------------------------------------------------------------------------------------*/
/**
	* @brief 		ѕодключение IO(A,C,D,H) к APB
	* @param 		None
	* @reval		None	
	*/
void portClkInit(void)
...
{		
	//инициализаци€ RTC
	BSP_RTC_Init();
	//инициализаци€ обработчика устройств на шине
	Devices_Init();
	//инициализаци€ USB
	BSP_Usb_Init();
	//инициализаци€ SDCard SPI
	BSP_SDCard_Init();
	//инициализаци€ UART дл€ WiFi модул€
	BSP_WIFI_Init();
